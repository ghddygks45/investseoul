					...
					<div class="con_body">
						<div class="board_view">
							<div class="view_top">
								...
								<ul class="list01 sm-mt-10 lg-mt-10">
									...
									<li><strong>Year of establishment :</strong> 2020</li>
								</ul>
							</div>
						</div>
						<div class="section sm-mt-30 lg-mt-50">
							...
							<div class="sm-mt-20 lg-mt-25">
								<h5 class="tit02">Reason to Invest(Our Product &amp; Service)</h5>
							...
							<div class="sm-mt-20 lg-mt-25">
								<h5 class="tit02">Our Achievement</h5>
								<ul class="list01">
						...
						<div class="section">
							...
							Want more information about this company? Leave a message and we will contact you.
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" class="txt_input" placeholder="Enter Organization name">
											</td>
										</tr>
										<tr>
											<th scope="row">Type of Company</th>
											<td>
												<select class="select_box">
													<option>Select a Type of Company</option>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" class="txt_input" placeholder="Enter a Name">
											</td>
										</tr>
										<tr>
											<th scope="row">Job Title</th>
											<td>
												<input type="text" class="txt_input" placeholder="Enter a Job Title">
											</td>
										</tr>
										<tr>
											<th scope="row" class="v_top">E-Mail</th>
											<td>
												<div class="email_box">
													<div class="l"><input type="text" class="txt_input" placeholder="Enter E-Mail"></div>
													<div class="r">
														<select class="select_box">
															<option>직접 입력</option>
														</select>
										...
										<tr>
											...
											<td>
												<input type="text" class="txt_input" placeholder="Enter Contact">
											</td>
										</tr>
										<tr>
											<th scope="row" class="v_top">Inquiry</th>
											<td>
							...
							<div class="privacy_box">
								<div class="info">
									We recognize the importance of privacy and confidentiality of personal information.<br
										class="pc-content">
									We protect and use personal information about you in limited scope by
									<strong>Korea Personal Information Act </strong> and our
									<strong>Privacy Policy.</strong><br class="pc-content">
									If you have read and agreed to our privacy policy, check the boxes and
									click "Send" button.
								</div>
								<div class="chk_box">
									<div class="chk_item">
										<input type="checkbox" id="chk01" checked>
										<label for="chk01">I have read and agreed to the <span class="txt_underline color-green fwr">Privacy
												Policy</span>.</label>
									</div>
									<div class="chk_item color-black fwr">
										<input type="checkbox" id="chk02">
										<label for="chk02">I agree to my data being stored and used to receive our contact for meeting your
											inquiry.</label>
									</div>
								</div>
							</div>
							<div class="board_btm_btn">
								<div class="flex_box">
									<div class="l"><a href="invest02_2.jsp" class="btn btn_black">List</a></div>
									<div class="r"><a href="#n" class="btn btn_green">Enter</a></div>
								</div>
							</div>
						</div>
					</div>
